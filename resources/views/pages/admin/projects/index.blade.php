        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$project->name}}</td>
                        <td class="font-w400 font-size-sm">{!! str_limit($project->description, 40, '...') !!}</td>
                        <td class="font-size-sm">
                            <em class="text-muted font-size-sm">{{\Carbon\Carbon::parse($project->created_at)->diffForHumans()}}</em>
                        </td>
                       
                        <td class="text-center">
                            <div class="btn-group">
                                <a type="button" href="{{route('editproject', $project->id)}}" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Edit">
