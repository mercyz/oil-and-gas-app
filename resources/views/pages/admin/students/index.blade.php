    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2">
                Students<small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
            </h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href=""> all students</a>
                    </li>
                </ol>
            </nav>
        </div>
...
<div class="block">
	...
	<h3 class="block-title">All Students<small> Record</small></h3>
	</div>
...
<tbody> 
	...
	<tr role="row" class="odd">
	    ...
	    <td class="font-w600 font-size-sm">
	        <a href="be_pages_generic_blank.html">{{$student->firstname}} {{$student->lastname}}</a>
	    </td>
	    <td class="d-none d-sm-table-cell font-size-sm">
	        <em class="text-muted">{{$student->email}}</em>
	    </td>
	    <td class="d-none d-sm-table-cell">
	        <div class="btn-group">
                <a href="{{route('studentdetail', $student->id)}}" class="btn btn-sm btn-info js-tooltip-enabled">View</a>
                <a href="{{route('editStudent', $student->id)}}" class="btn btn-sm btn-primary js-tooltip-enabled" ><i class="fa fa-fw fa-pencil-alt"></i></a>
	    ...
	    <td>
	        <em class="text-muted font-size-sm">{{\Carbon\Carbon::parse($student->created_at)->diffForHumans()}}</em>
	    </td>
	</tr>
@endforeach
  	</tbody>
        </table></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="DataTables_Table_3_info" role="status" aria-live="polite">Page <strong>1</strong> of <strong>4</strong></div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_3_paginate"> {{ $students->links('vendor.pagination.oneuipaginator') }}</div></div></div></div>
    </div>
</div>
@endsection