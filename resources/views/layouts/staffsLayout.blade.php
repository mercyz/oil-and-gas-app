...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="{{ asset('uploads/staffs/profile/'.Auth::user()->profileimage) }}" alt="">
                    </a>
                    <!-- END User Avatar -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('index') ? ' active' : '' }}" href="{{route('staffsdashboard')}}">
                         ...
                         <li class="nav-main-item open">
                            <a class="nav-main-link" href="{{route('viewprofile', Auth::user()->id)}}">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="{{ asset('uploads/staffs/profile/'.Auth::user()->profileimage) }}" alt="Header Avatar" style="width: 18px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                ...
                                <div class="p-2">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{route('viewprofile', Auth::user()->id)}}">
                                        <span>Profile</span>
                                        <span>
        ...
        document.getElementById('logout-form').submit();">
                        ...
                        <!-- Toggle Side Overlay -->
                        <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                        <button type="button" class="btn btn-sm btn-dual ml-2"  data-action="side_overlay_toggle">
