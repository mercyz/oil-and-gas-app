            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="{{ asset('/uploads/students/'.Auth::user()->profileimage) }}" alt="">
                    </a>
                    <!-- END User Avatar -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('dashboard') ? ' active' : '' }}" href="/student/dashboard">
                                <i class="nav-main-link-icon si si-home"></i>
                                <span class="nav-main-link-name">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-main-item{{ request()->is('pages/students/course/*') ? 'open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('pages/student/course/index') ? ' active' : '' }}" href="{{route('course-list')}}">
                                        <span class="nav-main-link-name">All Courses</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('pages/student/mycourse/') ? ' active' : '' }}" href="{{route('my-courses')}}">
                                        <span class="nav-main-link-name">My Course(s)</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/blank') ? ' active' : '' }}" href="#">
                           ...
                           <li class="nav-main-item{{ request()->is('pages/admin/students/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('/pages/admin/students/index') ? ' active' : '' }}" href="#">
                                        <span class="nav-main-link-name">All Events</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('pages/admin/students/addstudent') ? ' active' : '' }}" href="#">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="{{ asset('/uploads/students/'.Auth::user()->profileimage) }}" alt="Header Avatar" style="width: 18px;">
                                <span class="d-none d-sm-inline-block ml-1">{{Auth::user()->firstname}}</span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('/uploads/students/'.Auth::user()->profileimage) }}" alt="">
                                </div>
                                <div class="p-2">
                ...
                <div class="content py-3">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="https://1.envato.market/xWy" target="_blank">Surevisco</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
